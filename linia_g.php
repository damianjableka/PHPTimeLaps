...
{
$funcBold($resourceG, $x1G, $y1G, $x2G , $y2G, $raG, $gaG, $baG, $alphaaG+5, $BoldNessG+2,$funcG);
...
imageBoldLine($im,473,43,516,74,0,0,255,110,4,"imageSmoothAlphaLine","imageBoldLine");

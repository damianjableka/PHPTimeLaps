...
{
imagesetthickness($resourceG, $BoldNessG+6);
$funcG($resourceG, $x1G, $y1G, $x2G , $y2G, $raG, $gaG, $baG, $alphaaG+8);
imagesetthickness($resourceG, $BoldNessG);
$funcG($resourceG, $x1G, $y1G, $x2G , $y2G, $raG, $gaG, $baG, $alphaaG);
